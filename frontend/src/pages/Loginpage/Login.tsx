  ...
  const LoginForm = (
    <>
      ...
      <p className="mt-2 text-slate-600">
        Sign in to continue to <span className="text-blue-600 font-semibold">Provider IQ</span>
      </p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-ai">
      ...
      >
        ...
        <div className="right-panel-shell px-6 md:px-10 py-8 md:py-12 relative">
          ...
          <div id="rightPanel" ref={rightPanelRef} className="h-full w-full flex items-center justify-center">
            <div className="flex flex-col items-center gap-6">
              <div id="agenticButton" ref={buttonRef} className="button-track">
                ...
                <div className="button-label">Provider IQ</div>
              </div>
